...
#define ContArrayRead				0x68	// Continuous Array Read (Note : Only A/B-parts supported) //68
...
#define TOP_PAGE 2048
#define M_DATAFLASH_FULL 0xFF
#define main_page_read 0xD2
#define Page_Erease 0x81
//Pin definitions for interface to the Dataflash


//Dataflash macro definitions
#define DF_CS_active	cbi(PORTC,0)
#define DF_CS_inactive	sbi(PORTC,0)
