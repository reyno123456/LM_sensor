#line 1 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\usart.c"
//usart.c
...
#line 4 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\usart.c"
...
#line 5 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\usart.c"
...
#line 6 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\usart.c"
...
#line 7 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\usart.c"
...
#line 8 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\usart.c"
...
/****************	add by alan end	**************************/
#line 9 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\usart.c"
...
// add by alan end
#line 10 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\usart.c"
...
#line 11 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\usart.c"
...
#line 12 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\usart.c"

char rx_buffer[200]; // 接收缓冲区，为char型变量组成的数组，该数组构成环形队列，个数为RX_BUFFER_SIZE 
...
#line 30 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\usart.c"
...
__interrupt void usart0_tx_ser(void)
{
    if (tx_counter)
    {
           ...
           if (++tx_rd_index == 16) tx_rd_index=0;
    }; 
}
/**//*发送单个字符*/
void put_c(unsigned char c)
{
    while (tx_counter == 16);   //发送数据队列中还有数据没有发送完，等待

    __disable_interrupt();
    if (tx_counter || ((UCSR0A & (1<<5))==0))    //若发送数据队列有数据或者数据寄存器UDR非空时执行(因为队列先进先出的原因，所以，c要放进非空的发送数据队列里面)
    {
           tx_buffer[tx_wr_index]=c;
           if (++tx_wr_index == 16) tx_wr_index=0;
           ++tx_counter;
       }
    else
           UDR0=c;
