#line 1 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\PIR.c"
...
#line 2 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\PIR.c"
...
#line 3 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\PIR.c"
...
#line 4 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\PIR.c"
...
#line 5 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\PIR.c"
...
/****************	add by alan end	**************************/
#line 6 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\PIR.c"
...
// add by alan end
#line 7 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\PIR.c"
...
#line 8 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\PIR.c"
...
***************************************************/	
		if(1)//(pir.fPIRdetectionEnable == 1)    //the signal of Warm up
		{
		  ...
		  ucCurrentPIRSample = read_adc8bit(0);
			asm("nop");
			ucCurrentPIRSample = read_adc8bit(0);		// add 0603
			
		  if (ucCurrentPIRSample >= 105)
				ucCurrentPIRSample -= 105;
		  else      
				ucCurrentPIRSample = 105 - ucCurrentPIRSample;
			...
			if (ucCurrentPIRSample >= ucThreshHold)    			//当前PIR信号大于设定值
			{
				...
				{                                    			//且信号高部分大于零  
					...
					if (ucCurHighLength >= 35)  			//且信号高部分持续时间大于设定的时间宽度时，PIR触发
					{
			...
			{	
				...
				{
					if (((ucLastHighLength >= 2) && (ucCurHighLength >= 2) && ((ucLastHighLength >= 5) || (ucCurHighLength >= 5)) && (ucLastHighLength + ucCurLowLength + ucCurHighLength <= 140)) 
								|| ((ucLastLastHighLength >= 2) && (ucLastHighLength >= 2) && (ucCurHighLength >= 2) && (ucLastLastHighLength + ucLastLowLength + ucLastHighLength + ucCurLowLength + ucCurHighLength <= 140)))
					{
					...
					ucCurLowLength += (ucCurLowLength >= 140) ? 0 : 1;
...
**    add on 0525
***************************************************/	
#line 190 "D:\\avr\\Uart_Interrupt\\LM_Universal\\LM_IAR_V5.0\\Alan\\PIR.c"
