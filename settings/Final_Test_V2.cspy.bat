...
"C:\Program Files\IAR Systems\Embedded Workbench 5.4\common\bin\cspybat" "C:\Program Files\IAR Systems\Embedded Workbench 5.4\avr\bin\avrproc.dll" "C:\Program Files\IAR Systems\Embedded Workbench 5.4\avr\bin\avrJtagIce-mkII.dll"  %1 --plugin "C:\Program Files\IAR Systems\Embedded Workbench 5.4\avr\bin\<libsupport_plugin>" --backend -B "--cpu=m644p" "--enhanced_core" "-p" "C:\Program Files\IAR Systems\Embedded Workbench 5.4\avr\Config\iom644p.ddf" "--eeprom_size" "2048" "-d" "jtagIceMkII" "--jtagice_clock=3600000" "--jtagice_leave_timers_running" "--jtagice_preserve_eeprom" "--jtagicemkII_use_software_breakpoints" "--drv_set_putchar_breakpoint" "--drv_set_getchar_breakpoint" "--drv_communication=USB" 
